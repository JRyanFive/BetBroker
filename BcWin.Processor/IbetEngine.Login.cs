...
{
    public partial class IbetEngine
    {
        ...
        public bool LoginProxy(string url, string userName, string password)
        {
            ...
            try
            {
                ...
                ////Begin check login
                objCheckLoginTimer = new Timer(CheckLoginCallback, null, 0,
        ...
        public bool LoginNomal(string url, string userName, string password)
        {
            ...
            try
            {
                ...
                var docrootLeftInOne = new HtmlDocument();
